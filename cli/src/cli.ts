...
const service = defineCommand({
  meta: { name: "service", description: "manage the daily background sync (install/status/uninstall)" },
  subCommands: {
    install: defineCommand({
      meta: { name: "install", description: "start syncing daily in the background" },
      async run() {
